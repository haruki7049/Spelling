...
- **Directory Structure**:
  ...
  - `internal/vm/`: Virtual CPU that runs Idea, the in-game RISC-V RV32I machine code (`cpu.go`: instruction execution, `bus.go`: memory interface and RAM). Game-specific behavior is tracked in issue #15.
